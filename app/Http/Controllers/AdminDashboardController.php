...
class AdminDashboardController extends Controller
{
    ...
    public function getDashboard(Request $request)
    {
        ...
        $no_kafa_exam = kafaExam::get()->count();

        $no_kafa_exam_students = kafaExam::select(DB::raw('sum(number_students) as no_kafa_exam_students'))->first();
        $no_kafa_exam_pass = kafaExam::select(DB::raw('sum(number_pass) as no_kafa_exam_pass'))->first();


        $no_students_course = StudentEnroll::select(
            'academic_year_id',
            'academic_years.name',
