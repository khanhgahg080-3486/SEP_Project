...
@section('content')
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            {{--                                        <div class="col"> --}}
            {{--                                            <span --}}
            {{--                                                hidden>{{$per = round(($enroll->kafa_exam_pass/(($enroll->kafa_exam_modules==0)?1:$enroll->kafa_exam_modules))*100)}}</span> --}}
            ...
            {{--                                        </div> --}}
            {{--                                        <div class="col-auto text-right"> --}}
            {{--                                            <div>{{$enroll->kafa_exam_pass}} Pass</div> --}}
            {{--                                            <div>{{$enroll->kafa_exam_modules}} Exams</div> --}}
            {{--                                        </div> --}}
            {{--                                    </div> --}}
            {{--                                </div> --}}
            {{--                            </div> --}}
