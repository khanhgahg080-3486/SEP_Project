...
@section('title')
    KAFA Examination Results Summary
@endsection
@section('content')
    <div class="card mb-3">
        <div class="card-header bg-white">
            <div class="align-items-center row">
                <div class="col">
                    <h5 class="mb-0 font-weight-bolder">KAFA Examination Results Summary</h5>
                </div>
                <div class="text-right col-auto">
                    {{--                <a type="button" class="btn btn-sm btn-outline-primary shadow-sm" href="{{route('kafa.exams.create')}}">New</a> --}}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row align-items-center mt-2">
        <div class="col-6">
            <form class=" my-2 my-lg-0" action="{{ route('kafa.results.batch') }}" method="POST">
                <div class="card mb-3 tborder-light mb-3">
                    ...
                    <div class="card-footer bg-white">
                        <div class="pt-1 no-gutters row">
                            ...
                            <div class="col-auto">
                                <button type="submit" class="btn btn-sm btn-primary my-2 my-sm-0"><i
                                        class="fas fa-search"></i> View Results</button>
