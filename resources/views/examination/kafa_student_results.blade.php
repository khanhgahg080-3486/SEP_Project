    ...
    <div class="card mb-3">
        <div class="card-header bg-white">
            <div class="align-items-center row">
                <div class="col">
                    <h5 class="mb-0 font-weight-light text-uppercase">student's academic transcript - KAFA Examination</h5>
                </div>
                <div class="text-right col-auto">
                    <a type="button" class="btn btn-sm btn-light shadow-sm" href="{{ route('students.create') }}"><i
                        ...
                        @foreach ($results as $result)
                            @if (!($isPrint == $result->module_code . $result->exam_type))
                                ...
                                <tr>
                                    ...
                                    <td><i
                                            class="fas {{ $result->result == 'P' ? 'fa-check-circle text-success' : 'text-danger fa-times-circle' }}"></i>
                                        {{ $exam_pass[$result->result] }}</td>
