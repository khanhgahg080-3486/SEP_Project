        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('kafa.exams') }}">kafa Examinations</a>
                        <a class="dropdown-item" href="{{ route('kafa.results') }}">kafa Results</a>
                    </div>
                </li>
                {{--                <li class="nav-item dropdown"> --}}
                {{--                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" --}}
                ...
                {{--                </li> --}}
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('attendances') }}"><i class="fas fa-calendar-day"></i>
                        Attendances</a>
                </li>
                <li class="nav-item">
