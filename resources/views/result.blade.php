                    ...
                    <div class="form col">
                        <div class="card text-uppercase">
                            ...
                            <div class="card-header bg-primary text-light">
                                <div class="align-items-center row">
                                    <div class="col">
                                        <h5 class="mb-0 font-weight-bolder">KAFA Exam Result</h5>
                                    </div>
                                            ...
                                            <tbody>
                                                @foreach ($rows as $result)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <i
                                                                class="{{ $result->result == 'P' ? 'fa fa-check text-success' : 'fa fa-times text-danger' }}"></i>
                                                            {{ $exam_pass[$result->result] }}
                                                        </td>
                                                        <td>Attempt {{ $result->attempt }} </td>
                                                        <td>{{ Carbon\Carbon::parse($result->exam_date)->toFormattedDateString() }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                            ...
                                            <tbody>
                                                @foreach ($rows as $attendance)
                                                    <tr>
                                                        ...
                                                        <td>{{ $attendance->total > 0 ? round(($attendance->present / $attendance->total) * 100, 2) : '0' }}%
                                                        </td>
                            ...
                            <div class="card-footer bg-light">
                                <div class="row">
                                    <div class="col">
                                        <h6 class="text-center text-secondary text-uppercase">This is a computer generated
                                            report and this will be not considered as an official document of Sri
